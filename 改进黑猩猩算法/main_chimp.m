...
for cnt = 1:cnt_max
    ...
    [HHO_gBestScore(cnt),HHO_gBest,HHO_cg_curve]=HHO(N,Max_iteration,lb,ub,dim,fobj);
...
figure;
t = 1:Max_iteration;
semilogy(t, MPSO_cg_curve, 'rd-',t, HHO_cg_curve, 'B>-',t, AO_cg_curve, 'CO-',t, PSO_cg_curve, 'c^-',t, TACPSO_cg_curve, 'g<-',t, Chimp_curve, 'bs-', t, Chimp_curve_SLWChoA, 'mo-',...
    'linewidth', 1.5, 'MarkerSize', 6, 'MarkerIndices', 1:25:Max_iteration);
title(Function_name)
xlabel('Iteration');
ylabel('log(Fitness value)');
axis fill
grid on
box on
legend('MPSO','HHO','AO','PSO','TACPSO','Chimp','SLWchoa');
